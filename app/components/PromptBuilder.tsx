  ...
  const generatePrompt = () => {
    return selectedBlocks
      .map((selection) => {
        ...
        if (!block) return '';
        return block.promptText + (selection.customInput ? ' ' + selection.customInput : '');
      })
      .join('. ') + '.';
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-900 to-black text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-16 bg-gray-800/50 rounded-xl p-8 backdrop-blur-sm border border-gray-700/50 shadow-xl">
          ...
          <div className="bg-gray-900/50 rounded-xl p-6 font-mono text-sm text-gray-300 min-h-[120px] whitespace-pre-wrap border border-gray-700/50 shadow-inner">
            {generatePrompt() || 'Select blocks above to build your prompt...'}
          </div>
